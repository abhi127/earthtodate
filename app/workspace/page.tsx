      ...
      <header className="pointer-events-none absolute inset-x-0 top-0 z-20 flex items-center gap-3 p-3">
        ...
        {user ? (
          <Link
            href="/dashboard"
            title="Dashboard"
            className="glass pointer-events-auto grid h-10 w-10 place-items-center rounded-xl border border-line text-[13px] font-bold text-accent shadow-panel transition-colors hover:border-accent/40"
          >
          ...
          <Link
            href="/login"
            className="glass pointer-events-auto rounded-xl border border-line px-3.5 py-2.5 text-[12.5px] font-semibold text-txt-secondary shadow-panel transition-colors hover:text-txt-primary"
          >
            Sign in
          </Link>
        )}
